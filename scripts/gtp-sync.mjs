...
function main() {
  ...
  lines.push('---')
  lines.push('Desarrollo: npm run dev → Vite :5173 (localhost, strictPort).')
  lines.push('Cursor/VSCode: tarea waitme: start manual → npm dev + shell que abre Safari cuando responde :5173.')
