...
-- Duplicado como 0005 porque proyectos remotos pueden tener otro SQL en la ranura 0003
-- (p. ej. solo perfiles); este bloque asegura tablas DM + RPC en producción.
...
create trigger waitme_dm_messages_touch_thread
  ...
  for each row execute function public.waitme_touch_dm_thread_updated_at();
